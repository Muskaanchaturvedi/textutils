        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
                Textutils is an app that helps you analyze text and get the most out of it. It provides a range of features that can help you gain insights into your text, be it word count, character count and analyzes the average time to read the text.Further it also provides variety of options to manipulate your text, the way you want.
            </div>
          </div>
        </div>
        <div className="accordion-item">
